...
public class WalkThrough extends AppCompatActivity {
    ...
    private String[] description_array = {
            "MARI BERKENALAN DENGANKU", "MARI LIHAT KEGIATANKU",
            "MARI LEBIH DEKAT DENGANKU"
    };
    ...
    private int[] color_array = {
            R.color.teal_200,R.color.teal_200,R.color.teal_200
    };
    ...
    private void initComponent() {
        ...
        btn_got_it.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WalkThrough.this, BottomNavigation.class);
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View view = layoutInflater.inflate(R.layout.item_wt, container, false);
